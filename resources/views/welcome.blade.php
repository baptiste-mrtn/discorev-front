...
@section('content')
    ...
    <section class="explore-companies">
        ...
        <div class="row gy-4 mt-4 mb-5">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="company-card">
                    <img src="{{ asset('img/azae.jpg') }} alt="Entreprise 2">
                    <h3>Azaé</h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="company-card">
                    <img src="{{ asset('img/peit-fils.jpg') }} alt="Entreprise 3">
                    <h3>Petit Fils</h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="company-card">
                    <img src="{{ asset('img/senior-compagnie.png') }} alt="Entreprise 4">
        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="{{ asset('img/bureau.jpg') }} alt="Suivi des candidatures" class="img-fluid rounded">
                </div>
                <div class="col-lg-6">
                    <h2>Suivez votre candidature en temps réel</h2>
                    <p>Ne restez plus dans le flou ! Postulez et suivez l’avancée de vos candidatures à chaque étape. Vous
            ...
            <div class="row align-items-center flex-lg-row-reverse mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="{{ asset('img/bureau.jpg') }} alt="Offres transparentes" class="img-fluid rounded">
                </div>
                <div class="col-lg-6">
                    <h2>Des offres d’emploi sans surprise</h2>
                    <p>Fini les annonces vagues ! Salaire, conditions de travail, avantages… Vous avez toutes les infos pour
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="{{ asset('img/bureau.jpg') }} alt="Recruteurs transparents" class="img-fluid rounded">
                </div>
                <div class="col-lg-6">
                    <h2>Des recruteurs à votre écoute</h2>
                    <p>Découvrez des entreprises qui recrutent activement et qui partagent leurs valeurs, leurs processus et
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 text-center mb-4 mb-lg-0">
                    <img src="{{ asset('img/mockup-app.png') }} alt="Aperçu de l'application Discorev"
